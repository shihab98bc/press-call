...
import { getDatabase, ref, onValue, set, push, serverTimestamp, query, orderByChild, equalTo, off, get, remove, runTransaction } from 'firebase/database';
...
export const useFirebase = () => {
    ...
    const setupAuthStateListener = useCallback((onUser, onNoUser) => {
