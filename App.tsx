...
import { View, UserProfile, Contact, FriendRequest, Message, CallData, CallType } from './types';
...
const App: React.FC = () => {
    ...
    }, [userProfile, setupContactsListener, setupFriendRequestsListener, setupCallHistoryListener]);
    ...
    return (
      <IconContext.Provider value={{ color: '#f0f2f5', size: '24px' }}>
        <div className="w-full h-full max-w-[450px] max-h-[950px] bg-[#f0f2f5] shadow-2xl rounded-lg flex flex-col relative overflow-hidden mx-auto my-auto">
          {renderView()}
